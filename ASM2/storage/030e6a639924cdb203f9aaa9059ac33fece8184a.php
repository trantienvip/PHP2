            ...
            <div class="container mt-4">
                <div class="box-form-create">
                        <div class="form-group">
                            <label for="nameProduct">Avatar: <img width="50px" src="<?php if(!empty($user->avatar)): ?><?php echo e($user->avatar); ?> <?php else: ?> <?php echo e(PUBLIC_PATH); ?>assets\images\users\user-1.jpg <?php endif; ?>" alt=""></label>
                        </div>
                        <div class="form-group">
...
<?php echo $__env->make('admin.admin-layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\TAIXAM\htdocs\PHP2\ASM2\app\views/admin/cpanel-information.blade.php ENDPATH**/ ?>
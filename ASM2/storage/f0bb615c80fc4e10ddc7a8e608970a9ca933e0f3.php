...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-md-12">
          <a href="<?php echo e(BASE_URL.'cpanel/restoreall'); ?>" class="btn btn-success">Khôi phục tất cả</a>
                ...
                <tbody id="show">
                    <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><a class="btn btn-primary" href="<?php echo e(BASE_URL . 'cpanel/restore/' . $p->id); ?>">Khôi phục</a></td>
                            <td><button data-toggle="modal" data-target="#deleteProduct" value="<?php echo e($p->id); ?>" class="btn btn-danger bnt-confirm-delete" href="<?php echo e(BASE_URL . 'cpanel/del/' . $p->id); ?>">Xóa vĩnh viễn</button></td>
                        </tr>
...
<?php echo $__env->make('admin.admin-layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\TAIXAM\htdocs\PHP2\ASM2\app\views/admin/bin.blade.php ENDPATH**/ ?>